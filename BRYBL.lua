...
local function CreateToggle()
    ...
    toggleButton.Image = "rbxassetid://96114075322069"
    toggleButton.Image = "rbxassetid://96114075322069"
        ...
        if UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled then
            ...
            FeariseToggle.MouseButton1Click:Connect(function()
                for _, guiObject in ipairs(game:GetService("CoreGui"):GetChildren()) do
                    if guiObject.Name == "BORY HUB" and guiObject:IsA("ScreenGui") then
...
local Window = Fluent:CreateWindow({
    Title = "BORY HUB" .. " | ".."Blue Lock : Rival".." | ".."[V1]",
    SubTitle = "by Bô Ry",
    TabWidth = 125,
    Size =  Device, --UDim2.fromOffset(480, 360), --default size (580, 460)
    Acrylic = false, -- à¸à¸²à¸£à¹€à¸à¸¥à¸­à¸­à¸²à¸ˆà¸•à¸£à¸§à¸ˆà¸ˆà¸±à¸à¹„à¸”à¹‰ à¸à¸²à¸£à¸•à¸±à¹‰à¸‡à¸„à¹ˆà¸²à¸™à¸µà¹‰à¹€à¸›à¹‡à¸™ false à¸ˆà¸°à¸›à¸´à¸”à¸à¸²à¸£à¹€à¸à¸¥à¸­à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸”
    Theme = "Crimson", --Amethyst
...
do
    ...
    local Debris_Variables = {
        ...
        Raycast = {
            ...
            rayPart, -- à¹€à¸ªà¹‰à¸™à¸—à¸µà¹ˆà¹à¸ªà¸”à¸‡à¸§à¸´à¸–à¸µà¸¥à¸¹à¸à¸à¸­à¸¥
            tween -- Tween à¸›à¸±à¸ˆà¸ˆà¸¸à¸à¸±à¸™
    ...
    Function_Storage.CurveShoot = function(ball, startPos, targetCF, height, duration, curveIntensity)
        ...
        connection = Services.RunServices.RenderStepped:Connect(function()
            ...
            -- à¹ƒà¸à¹‰ sin à¹à¸¥à¸° cos à¹€à¸à¸·à¹ˆà¸­à¸—à¸³à¹ƒà¸«à¹‰à¸§à¸´à¸–à¸µà¸à¸²à¸£à¹€à¸„à¸¥à¸·à¹ˆà¸­à¸™à¸—à¸µà¹ˆà¹€à¸›à¹‡à¸™à¸§à¸‡à¸à¸¥à¸¡ (à¹€à¸ªà¹‰à¸™à¸§à¸‡à¹à¸«à¸§à¸™)
            local angle = t * math.pi * 2 * curveIntensity -- à¸„à¸§à¸à¸„à¸¸à¸¡à¸„à¸§à¸²à¸¡à¹€à¸£à¹‡à¸§à¸à¸²à¸£à¸«à¸¡à¸¸à¸™
            ...
            -- à¹€à¸à¸´à¹ˆà¸¡à¸„à¸§à¸²à¸¡à¸ªà¸¹à¸‡à¹ƒà¸«à¹‰à¸¥à¸¹à¸à¸¥à¸­à¸¢à¸‚à¸¶à¹‰à¸™à¹„à¸›à¸à¹ˆà¸­à¸™à¸•à¸à¸¥à¸‡à¸¡à¸²à¹à¸à¸à¹‚à¸„à¹‰à¸‡
            local arcHeight = math.sin(t * math.pi) * height
    
            -- à¸«à¸¡à¸¸à¸™à¸£à¸­à¸à¸•à¸±à¸§à¹€à¸­à¸‡
            local spinEffect = math.rad(t * 360 * 4) -- à¸«à¸¡à¸¸à¸™à¹€à¸£à¹‡à¸§à¸‚à¸¶à¹‰à¸™
    
            -- à¸›à¸£à¸±à¸à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡à¸¥à¸¹à¸à¸à¸­à¸¥à¹ƒà¸«à¹‰à¹€à¸„à¸¥à¸·à¹ˆà¸­à¸™à¸—à¸µà¹ˆà¹€à¸›à¹‡à¸™à¸§à¸‡à¹à¸«à¸§à¸™
            ball.CFrame = CFrame.new(
                ...
                lerpPos.Z
            ) * CFrame.Angles(0, spinEffect, 0) -- à¸«à¸¡à¸¸à¸™à¸£à¸­à¸à¸•à¸±à¸§à¹€à¸­à¸‡
        end)
    end
    ...
    Function_Storage.CreateFeariseHubMobileToggle = function()
		...
		feariseHubMobile.Name = "BORY HUBMobile"
        ...
        instantKick.Image = "rbxassetid://96114075322069"
        ...
        kaiserImpack.Image = "rbxassetid://96114075322069"
        ...
        curveShotProMax.Image = "rbxassetid://96114075322069"
        ...
        autoGK.Name = "AutoGK"
        autoGK.Image = "rbxassetid://96114075322069"
        ...
        hitBox.Name = "HitBox"
        hitBox.Image = "rbxassetid://96114075322069"
    ...
    function updateBall()
        if not getgenv().Settings.BallPredicToggle then return end -- à¸–à¹‰à¸² Toggle à¸›à¸´à¸” à¹„à¸¡à¹ˆà¸•à¹‰à¸­à¸‡à¸­à¸±à¸›à¹€à¸”à¸•à¸à¸­à¸¥
    ...
    function predictBallPath()
        ...
        -- à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸à¸§à¹ˆà¸²à¸à¸­à¸¥à¸à¸³à¸¥à¸±à¸‡à¹€à¸„à¸¥à¸·à¹ˆà¸­à¸™à¸—à¸µà¹ˆà¸«à¸£à¸·à¸­à¹„à¸¡à¹ˆ
        if velocity.Magnitude < Debris_Variables.Raycast.VELOCITY_THRESHOLD or movementAmount < Debris_Variables.Raycast.MOVEMENT_THRESHOLD then
            if Debris_Variables.Raycast.rayPart then
                -- à¸–à¹‰à¸²à¸à¸­à¸¥à¸à¹‰à¸²à¸¡à¸²à¸ à¸›à¸£à¸±à¸à¸‚à¸™à¸²à¸”à¹€à¸ªà¹‰à¸™à¹ƒà¸«à¹‰à¹€à¸¥à¹‡à¸à¸¥à¸‡ à¹à¸—à¸™à¸—à¸µà¹ˆà¸ˆà¸°à¸‹à¹ˆà¸­à¸™
    ...
    AutoTeamToggle:OnChanged(function()
        task.spawn(function()
            ...
            while AutoTeamToggle.Value do
                -- à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸à¸§à¹ˆà¸²à¸œà¸¹à¹‰à¹€à¸¥à¹ˆà¸™à¸­à¸¢à¸¹à¹ˆà¹ƒà¸™à¸—à¸µà¸¡ Visitor
                ...
                task.wait(3) -- à¸£à¸­ 3 à¸§à¸´à¸™à¸²à¸—à¸µà¸à¹ˆà¸­à¸™à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸à¹ƒà¸«à¸¡à¹ˆ
            end
        end)
    end)
        ...
        task.spawn(function()
            ...
            if NoCooldownStealToggle.Value then   
                ...
                Debris_Variables.NoCooldownStealToggle.newSteal = function(v11, v12, v13)
                    -- à¸‚à¹‰à¸²à¸¡à¹€à¸‡à¸·à¹ˆà¸­à¸™à¹„à¸‚à¸„à¸¹à¸¥à¸”à¸²à¸§à¸™à¹Œà¹à¸¥à¸°à¸à¸¥à¸±à¸‡à¸‡à¸²à¸™
                    if false then -- à¸‚à¹‰à¸²à¸¡à¸à¸²à¸£à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸à¸—à¸¸à¸à¸­à¸¢à¹ˆà¸²à¸‡
                        return
                    end
                    ...
                    -- à¸ªà¹ˆà¸§à¸™à¸ªà¸³à¸«à¸£à¸±à¸à¹€à¸¡à¸·à¹ˆà¸­à¸œà¸¹à¹‰à¹€à¸¥à¹ˆà¸™à¸¡à¸µà¸à¸­à¸¥
                    if v13.Values.HasBall.Value then
                        ...
                        -- à¸ªà¹ˆà¸§à¸™à¸ªà¸³à¸«à¸£à¸±à¸à¹€à¸¡à¸·à¹ˆà¸­à¸œà¸¹à¹‰à¹€à¸¥à¹ˆà¸™à¹„à¸¡à¹ˆà¸¡à¸µà¸à¸­à¸¥
                        v11.AbilityController:AbilityCooldown("1", 1) -- à¹„à¸¡à¹ˆà¸¡à¸µà¸„à¸¹à¸¥à¸”à¸²à¸§à¸™à¹Œ
                        v11.StaminaService.DecreaseStamina:Fire(10) -- à¹„à¸¡à¹ˆà¸¥à¸” Stamina
                        v11.Animations:StopAnims()
                        ...
                        -- à¹€à¸£à¸µà¸¢à¸à¹ƒà¸à¹‰ RemoteEvent "Slide" à¹€à¸à¸·à¹ˆà¸­ FireServer
                        game:GetService("ReplicatedStorage").Packages.Knit.Services.BallService.RE.Slide:FireServer()
                
                        -- à¹ƒà¸à¹‰ TweenService à¹à¸—à¸™à¸à¸²à¸£à¸à¸¸à¹ˆà¸‡à¸”à¹‰à¸§à¸¢ BodyVelocity
                        local rootPart = v13.HumanoidRootPart
                        if rootPart then
                            local targetPosition = rootPart.Position + (rootPart.CFrame.LookVector * 30) -- à¸à¸¸à¹ˆà¸‡à¹„à¸›à¸‚à¹‰à¸²à¸‡à¸«à¸™à¹‰à¸² 10 à¸«à¸™à¹ˆà¸§à¸¢
                
                            local tweenInfo = TweenInfo.new(
                                0.4, -- à¸£à¸°à¸¢à¸°à¹€à¸§à¸¥à¸²à¸à¸¸à¹ˆà¸‡ (0.5 à¸§à¸´à¸™à¸²à¸—à¸µ)
                                Enum.EasingStyle.Linear, -- à¸£à¸¹à¸›à¹à¸à¸à¸à¸²à¸£à¹€à¸„à¸¥à¸·à¹ˆà¸­à¸™à¹„à¸«à¸§à¹à¸à¸ Linear
                                Enum.EasingDirection.Out, -- à¸—à¸´à¸¨à¸—à¸²à¸‡à¸à¸²à¸£à¹€à¸„à¸¥à¸·à¹ˆà¸­à¸™à¹„à¸«à¸§à¹à¸à¸ Out
                                0, -- à¸ˆà¸³à¸™à¸§à¸™à¸£à¸­à¸ (0 = à¹„à¸¡à¹ˆà¸—à¸³à¸‹à¹‰à¸³)
                                false, -- à¹„à¸¡à¹ˆà¸¢à¹‰à¸­à¸™à¸à¸¥à¸±à¸
                            ...
                            tween.Completed:Connect(function()
                                tween:Destroy() -- à¸¥à¸ Tween à¸«à¸¥à¸±à¸‡à¸à¸²à¸£à¹ƒà¸à¹‰à¸‡à¸²à¸™
                            end)
                        end
                    end
                end
                
                -- à¹à¸—à¸™à¸—à¸µà¹ˆà¸Ÿà¸±à¸‡à¸à¹Œà¸à¸±à¸™à¹ƒà¸™ ModuleScript
...
SaveManager:SetFolder("BORY HUB")
InterfaceManager:SetFolder("BORY HUB")
